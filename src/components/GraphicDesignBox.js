    ...
    <div class = "Box GD"> 
        ...
        <div class="imgFlex">
            ...
            <div  class="contain R">
                ...
                <div class="middle">
                    <Link class="titlesWhitetoRed" to={`/SixPack`}>Kunikos</Link>
                </div>
            </div>   
        </div>  
        <div class="imgFlex">
            <div  class="contain L">
                ...
                <div class="middle">
                    <Link class="titlesWhitetoRed" to={`/Raskog`}>Lost Dog</Link>
                </div>
            </div>
            <div  class="contain R">
        ...
        <div class="imgFlex">
            <div  class="contain" style={{ margin: "5px 5px 120px auto"}}>
                ...
                <div class="middle">
                    <Link class="titlesWhitetoRed" to={`/Raskog`}>Folly</Link>
                </div>
            </div>
            <div  class="contain" style={{ margin: "5px auto 120px 5px"}}>
                <img src="./Imgs/Cluster.jpg" alt=""class="image" />
                <div class="middle">
                    <Link class="titlesWhitetoRed" to={`/SixPack`}>Cluster</Link>
                </div>
            </div>   
        </div>     
    </div>
